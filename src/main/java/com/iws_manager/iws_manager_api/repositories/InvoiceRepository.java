...
public interface InvoiceRepository extends JpaRepository<Invoice, Long> {
    @EntityGraph(attributePaths = { "biller", "cancelledInvoice", "customer","customer.branch", "customer.companytype", "customer.country", "customer.state", "invoiceType", "network", "order", "payCondition", "vat"})
