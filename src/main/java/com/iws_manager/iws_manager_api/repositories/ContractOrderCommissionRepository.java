...
public interface ContractOrderCommissionRepository extends JpaRepository<ContractOrderCommission, Long> {
    ...
    @EntityGraph(attributePaths = {"basicContract", "basicContract.contractStatus", "basicContract.customer", "basicContract.customer.branch", "basicContract.customer.companytype", "basicContract.customer.country", "basicContract.customer.state", "basicContract.fundingProgram", "basicContract.employeeIws"})
