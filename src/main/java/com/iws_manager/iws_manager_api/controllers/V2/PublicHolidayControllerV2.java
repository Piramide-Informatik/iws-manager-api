...
public class PublicHolidayControllerV2 {
    ...
    public ResponseEntity<List<SimpleHolidayDTO>> getAllHolidaysWithWeekends(
        ...
        List<SimpleHolidayDTO> holidays = publicHolidayServiceV2.getSimpleHolidaysWithWeekends(year);
        return ResponseEntity.ok(holidays);
    }
    
    /**
     * V2 Endpoint: Obtiene feriados en un rango de fechas incluyendo sábados y domingos
     * Solo devuelve fecha y nombre
    ...
    public ResponseEntity<List<SimpleHolidayDTO>> getHolidaysInRange(
        ...
        List<SimpleHolidayDTO> holidays = publicHolidayServiceV2.getSimpleHolidaysInRange(startDate, endDate);
        return ResponseEntity.ok(holidays);
    }
    ...
    public ResponseEntity<List<SimpleHolidayDTO>> getDatabaseHolidays(
        ...
        List<SimpleHolidayDTO> holidays = publicHolidayServiceV2.getDatabaseHolidays(year);
        return ResponseEntity.ok(holidays);
    }
