...
public interface PublicHolidayServiceV2 {
    ...
    // ========== V2 ==========
    List<SimpleHolidayDTO> getSimpleHolidaysWithWeekends(Integer year, Long stateId);

    List<SimpleHolidayDTO> getSimpleHolidaysInRange(LocalDate startDate, LocalDate endDate, Long stateId);
    ...
    List<SimpleHolidayDTO> getDatabaseHolidays(Integer year, Long stateId);

    List<SimpleHolidayDTO> getDatabaseHolidaysInRange(LocalDate startDate, LocalDate endDate, Long stateId);
}