...
public interface SubcontractProjectService {
    ...
    List<SubcontractProject> getByMonthsGreaterThan(Integer months);
    List<SubcontractProject> getByMonthsLessThan(Integer months);
    List<SubcontractProject> getByYearAfter(LocalDate date);
    List<SubcontractProject> getByYearBefore(LocalDate date);
}
